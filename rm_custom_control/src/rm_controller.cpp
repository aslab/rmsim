		...
		public:
			...
			*/
			...
			void starting(const ros::Time& time)
			{
				 ...
				 /*
				 fault_flag = std::getenv("FAULT_FLAG");
				 std::cout << "FAULT_FLAG vale " << fault_flag << '\n';
				
				 if(fault_flag == "1"){
				 command_struct_.position_ = pos_command + 0.5;
				 }else{*/
				 command_struct_.position_ = pos_command;
				 //}
			...
			void update(const ros::Time& time, const ros::Duration& period)
			{
				...
				/*
				 ...
				 std::cout << "FAULT_FLAG vale " << fault_flag << '\n';				
				 if(fault_flag == "1"){
				 	command_position = command_struct_.position_ + 0.5;
				 }else{*/
				 	command_position = command_struct_.position_;
				 //}
...
PLUGINLIB_EXPORT_CLASS( rm_controller_ns::RMJointPositionController, controller_interface::ControllerBase)
/*
