...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def __init__(self):
        ...
        #f = open("log", "w+") #Creamos el archivo para el registro
    ...
    def send_to_rev3_r1(self):
        ...
        if self.lineEdit_rev3_r1.text() == 'a':
            ...
            rospy.wait_for_service('drop_leg')
            try:
                service = rospy.ServiceProxy('drop_leg', robominer_srv)
                service("Rev3_r_1")
    ...
    def send_to_rev11_r1(self):
        ...
        if self.lineEdit_rev11_r1.text() == 'a':
            client_Rev11_r_1.update_configuration(params_a)
