...
def talker():
    ...
    pos[0][1] = pos[0][1] - pi / 24
    pos[0][2] = pos[0][2] + pi / 24
    pos[4][1] = pos[4][1] - pi / 24
    pos[4][2] = pos[4][2] + pi / 24
    pos[2][1] = pos[2][1] - pi / 24
    pos[2][2] = pos[2][2] + pi / 24
    for x in range(2):
        # rospy.loginfo(pos)
    ...
    # rospy.sleep(1)
    # Avanzan r1, l2 y r3
    pos[0][0] = pos[0][0] + pi / 24
    pos[4][0] = pos[4][0] - pi / 24
    pos[2][0] = pos[2][0] + pi / 24
    # Empujan el cuerpo l1, r2 y l3
    pos[3][0] = pos[3][0] + pi / 24
    pos[1][0] = pos[1][0] - pi / 24
    pos[5][0] = pos[5][0] + pi / 24
    for x in range(2):
        # rospy.loginfo(pos)
    ...
    while not rospy.is_shutdown():
        ...
        pos[3][1] = pos[3][1] - pi/24
        pos[3][2] = pos[3][2] + pi/24
        pos[1][1] = pos[1][1] - pi/24
        pos[1][2] = pos[1][2] + pi/24
        pos[5][1] = pos[5][1] - pi/24
        pos[5][2] = pos[5][2] + pi/24
        for x in range(n):
            #rospy.loginfo(pos)
